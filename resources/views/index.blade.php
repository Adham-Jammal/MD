    ...
    <section class="hero">
        <div class="container">
            <div class="content">
                ...
                <h2 class="with-text">to you <span> We want to touch the brilliance with a hand of innovation in harmony with
                        the quality of your life.
                    </span></h2>
                <h2>a world of luxury mixed </h2>
                <h2>with beauty and creativity</h2>
            </div>
            <p class="mobile-text">Because We have Advanced insights into Consumer Behavior, Brand Awareness, innovation
                Opportunities. </p>
        </div>
            ...
            <div class="row">
                <div class="column col-md-5">
                    <div class="content">
                        <h4>ABOUT US</h4>
                        <p>
                            Years of experience and dive into the world of interior design, MD gained through it wide vision
                            dependent unique design style and the tastes that suit with the lives of customers in order to
                            provide the highest standards of perfection and quality and excellence
                            Who deserves it all who looking forward to luxury and originality?
                        </p>
                    </div>
                ...
                <div class="column col-6 col-md-3">
                    <div class="content">
                        ...
                        <p>Residential interior design with a touch of originality and sophistication design every space in
                            your home designed with live liness through the colours that combine relaxation from one side
                            and mastery from the other</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        ...
                        <a href="#">hla@pulpstudio.co<span class="arrow"><svg class="circle-svg"
                                    viewBox="0 0 100 100">
                                    <path
                                        d="M72.3 27.41 C 74.53166666666667 29.97 78.22 33.70666666666666 79.59 36.82 80.96000000000001 39.93333333333334 80.10833333333333 42.79666666666667 80.52 46.09 80.93166666666666 49.38333333333334 82.13666666666667 53.36 82.06 56.58 81.98333333333333 59.8 81.79 62.346666666666664 80.06 65.41 78.33 68.47333333333333 74.51833333333335 72.82333333333332 71.68 74.96 68.84166666666667 77.09666666666666 65.95 76.95666666666668 63.03 78.23 60.11 79.50333333333333 57.364999999999995 81.62166666666667 54.16 82.6 50.955 83.57833333333332 46.968333333333334 84.47333333333333 43.8 84.1 40.63166666666666 83.72666666666666 37.946666666666665 82.13666666666667 35.15 80.36 32.35333333333333 78.58333333333333 29.301666666666666 76.33666666666666 27.02 73.44 24.738333333333333 70.54333333333334 22.775000000000002 66.185 21.46 62.98 20.145 59.775 19.988333333333333 57.33 19.13 54.21 18.271666666666665 51.09 16.044999999999998 47.78333333333333 16.31 44.26 16.575 40.736666666666665 18.796666666666667 36.21333333333333 20.72 33.07 22.64333333333333 29.926666666666666 25.378333333333334 27.341666666666665 27.85 25.4 30.32166666666667 23.458333333333332 32.541666666666664 22.683333333333334 35.55 21.42 38.55833333333333 20.15666666666667 42.42 18.196666666666665 45.9 17.82 49.379999999999995 17.443333333333335 53.04666666666667 18.553333333333335 56.43 19.16 59.81333333333333 19.766666666666666 63.55500000000001 20.085 66.2 21.46 68.845 22.835 70.06833333333333 24.85 72.3 27.41z">
                                    </path>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-content">
                    <p>We take advantages of MD to explain all the requirements that are on your mind also analysis of your
                        personality and favorite colors
                        So that MD experts can find the best and most suitable designs that suit your personality and style
                        to get more comfort and fluidity to be present in the spaces that MD design for you
                    </p>
                    {{-- <ul>
    ...
    <section id="partners" class="mission">
        <div class="container">
            <div class="slider owl-carousel owl-drag owl-theme">
                <div class="slide">
                    <h2>Our goal at MD</h2>
                    <p>
                        In MD, we have one goal; it has to enjoy the experience of changing your space with us
                        Because we combine between interior design services and launch imagination and creativity without
                        limits
                        Starting from the first word with us and ending with getting impressive results surpass what was on
                        your mind
                    </p>
                </div>
                <div class="slide">
                    <h2>Consultations! </h2>
                    <p>
                        Gives you personal attention to help you implement your projects in the hands of a specialized and
                        qualified team to be able to develop a preliminary image and provide solutions suggestions and
                        designs that suit the needs of the project
                    </p>
                </div>
                <div class="slide">
                    <h2>Commercial interior design: </h2>
                    <p>
                        We develop and plan workspaces and contribute in a scientific and creative way to extract designs it
                        fits with the company's activity and its general image
                    </p>
                </div>
                <div class="slide">
                    <h2>Office interior design </h2>
                    <p>
                        Creating designs that characterized by demonstrating the visual identity of company and her image
                        and privileges and implementation according to advanced global foundation seeks to make the
                        company's customers more attached to it
                    </p>
                </div>
            </div>
        </div>
